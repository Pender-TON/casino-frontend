...
export const DesktopPlaceholder = (props: DesktopPlaceholderProps) => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-start gap-10 bg-table-desk-bg bg-[url('src/assets/wood-table-texture.webp')] p-10 text-white bg-blend-multiply">
      <img className="aspect-square min-h-40 min-w-40 self-center object-contain" src={desktopPlaceholderQr} />

      <div className="flex flex-col items-center gap-4 text-center">
        <p className="text-[40px] font-semibold leading-[38.4px]">Scan QR to play on phone</p>
        <p className="text-xl font-medium leading-[22.4px]">Experience the World of Casino using your mobile device</p>
      </div>
      ...
      <div className="flex gap-6">
        ...
        {import.meta.env.DEV && (
          <PrimaryButton className={'h-16 w-16'} onClick={handleClickForceDesktop}>
