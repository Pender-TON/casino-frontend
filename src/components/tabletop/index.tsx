...
import { CurrentTapModifier } from './current-tap-modifier'
...
export const Tabletop = () => {
  return (
    <div className="relative flex h-full w-full select-none flex-col items-center justify-between rounded-[20px] border-2 border-table-top-line">
      <div className="absolute left-0 top-0 h-12 w-[99px] rounded-br-[20px] border-b-2 border-r-2 border-table-top-line px-4 py-2.5">
        <CurrentTapModifier />
      </div>
